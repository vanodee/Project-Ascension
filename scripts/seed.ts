...
async function seedHomilies(clergyIds: Map<string, string>): Promise<void> {
  ...
  const homilies = [
    {
      ...
      scriptureReferences: ['John 6:51–58'],
    ...
    },
    {
      ...
      scriptureReferences: ['John 16:12–15'],
    ...
    },
    {
      ...
      scriptureReferences: ['Matthew 28:16–20'],
      liturgicalSeason: 'Easter',
      body: [
    ...
    },
    {
      ...
      scriptureReferences: ['John 14:23–29'],
      liturgicalSeason: 'Easter',
      body: [
    ...
    },
    {
      ...
      scriptureReferences: ['John 10:27–30'],
      liturgicalSeason: 'Easter',
      body: [
    ...
    },
    {
      ...
      scriptureReferences: ['Joel 2:12–18'],
  ...
  for (const h of homilies) {
    ...
    await client.createIfNotExists({
      ...
      scriptureReferences: h.scriptureReferences,
      liturgicalSeason: seasonMap[h.liturgicalSeason],
      body: portableText(h.body),
      audioDurationSeconds: h.audioDurationSeconds,
    });
    console.log(`  ${h.title}`);
  }
}
